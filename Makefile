...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name hybrid-workflows-operator-builder
	$(CONTAINER_TOOL) buildx use hybrid-workflows-operator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm hybrid-workflows-operator-builder
	rm Dockerfile.cross
